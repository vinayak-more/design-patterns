 ...
 * @date 14-Jan-2017
 */
package com.shop.example.ui.module.login;
...
public class LoginView extends AbstractView<LoginController> {
...
//        setCompositionRoot(layout);
    ...
    public void submitForm() {
        try {
            ...
            boolean onLoginEvent = getController().onLoginEvent(new LoginEvent(beanFieldGroup.getItemDataSource().getBean()));
